      ...
      <Helmet>
        ...
        {/* <div className="home">
          ...
          <ul className="home-ul">
            ...
            <li className="p-5"><Link to={"/home"}><b>HOME</b></Link></li>
            <li className="p-5"><Link to={"/shop"}><b>SHOP</b></Link></li>
            <li className="p-5"><Link to={"/pages"}><b>PAGES</b></Link></li>
            <li className="p-5"><Link to={"/blog"}><b>BLOG</b></Link></li>
            <li className="p-5 me-5"><Link to={"/contact"}><b>CONTACT</b></Link></li>
            <li className="p-5"><Link to={"/home"}><FontAwesomeIcon icon={faGratipay} /></Link></li>
            <li ><Link to={"/home"}><FontAwesomeIcon icon={faShoppingBag} /></Link></li>
          </ul>
          </Col>
          </Row>
        </div> */}
